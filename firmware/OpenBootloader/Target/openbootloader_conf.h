...
// I don't know what these are so I'm commenting them out. If they're important,
// something will break and I'll know. 
// It broke the USART and SPI messaging code. I'll leave them unchanged for now.

/* -------------------------- Definitions for Memories ---------------------- */
#define FLASH_BL_SIZE                     (512U * 1024U)  /* Size of FLASH 512 kByte */
...
#define CCM_RAM_SIZE                      (16U * 1024U)
#define CCM_RAM_START_ADDRESS             0x10000000U
#define CCM_RAM_END_ADDRESS               (CCM_RAM_START_ADDRESS + CCM_RAM_SIZE)

#define ICP1_SIZE                         (8U * 1024U)  /* Size of ICP (system memory) 8 kByte */
#define ICP1_START_ADDRESS                0x1FFFD800U  /* System memory registers address */
#define ICP1_END_ADDRESS                  (ICP1_START_ADDRESS + ICP1_SIZE)  /* System memory registers end address */

#define OB1_SIZE                          16U   /* Size of OB 16 Byte */
#define OB1_START_ADDRESS                 0x1FFFF800U  /* Option bytes registers address */
...
#define FLASH_INTF_REGS_START_ADDRESS     0x40022000U
#define FLASH_INTF_REGS_END_ADDRESS       0x40022023U
...
#define CCM_RAM_AREA                      0x3U  /* RAM Address area */
#define OB_AREA                           0x4U  /* Option bytes Address area */
#define FIR_AREA                          0x5U  /* Flash memory interface registers area*/
